...
export default function UpcomingPatientsPanel({ patients }) {
    // Filter to only upcoming patients
    const upcomingPatients = patients.filter(patient => patient.status === 'Upcoming');

    if (upcomingPatients.length === 0) {
        return (
            <div className="bg-white rounded-lg shadow p-4 mb-6">
                <h2 className="font-semibold text-lg mb-2 text-black">Upcoming Patients</h2>
    ...
    return (
        <div className="bg-white rounded-lg shadow p-4 mb-6">
            <h2 className="font-semibold text-lg mb-2">Upcoming Patients</h2>
